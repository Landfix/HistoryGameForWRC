...
namespace Localization_container
{
    ...
    {
        private static NoSerializedPair<T, IEnumerable<T>> HeadAndTail<T>(this IEnumerable<T> source)
        {    
            if (source == null)
                throw new ArgumentNullException("source");
            var en = source.GetEnumerator();
            en.MoveNext();
            return new NoSerializedPair<T, IEnumerable<T>>(en.Current, EnumerateTail(en));
        }
        ...
        public static NoSerializedPair<IList<string>, IEnumerable<IList<string>>> ParseHeadAndTail(TextReader reader,
